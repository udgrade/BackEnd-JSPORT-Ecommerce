package com.jsport.backend_ecommerce.config;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","http://localhost:5173","https://jsport-ecommerce.vercel.app","https://front-end-jsport-ecommerce-admin.vercel.app"));
